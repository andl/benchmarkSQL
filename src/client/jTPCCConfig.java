...
public interface jTPCCConfig
{
    ...
    public final static int defaultNumWarehouses = 1;
    public final static int defaultNumTerminals = 1;

    public final static int defaultPaymentWeight = 43;
    public final static int defaultOrderStatusWeight = 4;
    public final static int defaultDeliveryWeight = 4;
    public final static int defaultStockLevelWeight = 4;

    public final static int defaultTransactionsPerTerminal = -1;
    public final static int defaultMinutes = 1;
